...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand active" href="shipping2.php">Shipping Management System</a>
    </div>
...
<h1 class="text-center text-primary">Shipping</h1>
        ...
        <div class ="row">
        	<div class= "col-md-4 col-md-offset-4" ><h4 class="text-center text-danger"><b>Current Shipping List</b></h4></div>
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				...
				<thead>
					<th width="100">Shipping Company</th>
				...
				<tbody>
					...
					//burada sıralama yaptırdık id lerine göre
						$result = $db->query("SELECT * FROM shippingTable ORDER BY tracing_id ASC");
					...
					<tr>
						...
						<td><?=$orderList["company_name"];?></td>
						<td><?=$orderList["shipping_method"];?></td>
						<td><?=$orderList["tracing_id"];?></td>
