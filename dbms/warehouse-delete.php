...
if (isset($_GET['whid'])){
	if(is_numeric($_GET['whid'])){
		...
		header("Location: http://localhost/projectstep3/warehouse-delete.php");
	}
}
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="warehouse-delete.php">Deletion</a></li>
        <li><a href="warehouse-selection.php">Selection</a></li>
        <li class="dropdown">
        ...
        <div class ="row">
        	<div class= "col-md-2 col-md-offset-5" ><h4 class="text-center text-danger"><b>Current WareHouse List</b></h4></div>
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#myModal<?=$warehouseList["warehouse_ID"];?>">Delete</button></td>
						<!-- Modal -->
						<div id="myModal<?=$warehouseList["warehouse_ID"];?>" class="modal fade" role="dialog">
						  <div class="modal-dialog">
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        <p><b><?=$warehouseList["warehouse_ID"];?></b> Do you want to delete this item?</p>
						      </div>
						      <div class="modal-footer">
						      	<button type="button" class="btn btn-danger" data-dismiss="modal" onclick="location.href='?whid=<?=$warehouseList["warehouse_ID"];?>';">Confirm</button>
