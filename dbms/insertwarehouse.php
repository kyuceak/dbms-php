...
$sql_statement = "INSERT INTO warehouseTable(itemid, location,stock_quantity,category_id) VALUES ('$itemid','$location','$stock_quantity','$category_id')";
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="warehouse-insert.html">Insertion <span class="sr-only">(current)</span></a></li>
