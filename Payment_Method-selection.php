  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="Payment_Method-selection.php">Selection</a></li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="customer.php">Customer Management System</a></li>
				...
				<label><span>Enter your Credit Card information:</span>   </label>
				<input class="form-control" type="text" name="Customer_id" placeholder="Please enter your Credit Card information">
				<br>
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				...
				<tbody>
					...
					if(isset($_GET['Customer_id'])){
					$Customer_id = $_GET['Customer_id'];
						$result = $db->query("SELECT * FROM Payment_Method WHERE Customer_id='$Customer_id'");
