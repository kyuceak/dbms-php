...
?>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="Customer_Service.php">Customer Management</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="Customer_Service-delete.php">Deletion</a></li>
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<tbody>
					...
					//burada sıralama yaptırdık id lerine göre
						$result = $db->query("SELECT * FROM Customer_Service ORDER BY item_id ASC");
						  ...
						  <div class="modal-dialog">
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        <p><b><?=$Customer_Service_List["item_id"];?></b> Do you want to delete this item?</p>
						      </div>
