...
if (isset($_GET['customer_id'])){
		...
		header("Location: http://localhost/projectstep3/customer-delete.php");
	}
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="customer-delete.php">Deletion</a></li>
        ...
        <div class ="row">
        	<div class= "col-md-2 col-md-offset-5" ><h4 class="text-center text-danger"><b>Customer List</b></h4></div>
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<tbody>
					...
					//burada sıralama yaptırdık id lerine göre
						$result = $db->query("SELECT * FROM Customer ORDER BY customer_id ASC");
						//while döngüsü oluşturuyoruz çünkü satır satır tüm satıları almak istiyoruz
						while ($customerList= $result->fetch_array()) {
					...
					<tr>
						...
						<td><?=$customerList["customer_phonenumber"];?></td>
						<td><?=$customerList["customer_country"];?></td>
						<td><?=$customerList["customer_city"];?></td>
		
						<td class="text-center"><button class="btn btn-danger" data-toggle="modal" data-target="#myModal<?=$customerList["customer_id"];?>">Delete</button></td>
						<!-- Modal -->
						<div id="myModal<?=$customerList["customer_id"];?>" class="modal fade" role="dialog">
						  <div class="modal-dialog">
						    ...
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        <p><b><?=$customerList["customer_id"];?></b> Do you want to delete this item?</p>
						      </div>
						      <div class="modal-footer">
						      	<button type="button" class="btn btn-danger" data-dismiss="modal" onclick="location.href='?customer_id=<?=$customerList["customer_id"];?>';">Confirm</button>
