...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand active" href="company.php">Company Management</a>
    </div>
...
<h1 class="text-center text-primary">Company</h1>


				<div class="container">
		
        <div class ="row">
        	<div class= "col-md-4 col-md-offset-4" ><h4 class="text-center text-danger"><b>Company List</b></h4></div>
