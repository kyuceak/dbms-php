...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand active" href="Payment_Method.php">Payment Method Management</a>
    </div>
...
<h1 class="text-center text-primary">Payment Method</h1>


				<div class="container">
		
        <div class ="row">
        	<div class= "col-md-4 col-md-offset-4" ><h4 class="text-center text-danger"><b>Payment Method List</b></h4></div>
			...
			<div class="col-md-10 col-md-offset-1">
				...
				<tbody>
					...
					//burada sıralama yaptırdık id lerine göre
						$result = $db->query("SELECT * FROM Payment_Method ORDER BY Credit_Card ASC");
